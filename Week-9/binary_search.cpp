...
//Method to print the elements of the tree in preorder
...
//Method to print the elements of the tree in inorder
...
//Method to print the elements of the tree in postorder
	...
	while(1){
		...
		switch(choice){
			...
			case 6:
				...
				scanf("%d", &num);
				if(t.search(t.head, num)!=nullptr){
